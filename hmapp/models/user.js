...
userSchema.static({
    list: function(rows,page,callback){
        return this.model("User").find({},{email:1,phoneno:1,name:1,avatar:1})
            .skip(page * rows)
            .limit(rows)
            .exec(callback)
    },
    ...
    findByPhone: function(phoneno,callback){
        ...
        return this.model("User").findOne({phoneno:phoneno},{password:0}).exec(callback)
    },
    findByEmail: function(email,callback){
        return this.model("User").findOne({email:email},{password:0}).exec(callback)
    },
    findByWechat: function(openid,callback){
